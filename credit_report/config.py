...
SECTION_RETRIEVAL_KEYWORDS: dict[int, list[str]] = {
    ...
    3: ["rating", "credit risk", "MAS 612", "default", "ESG", "sanctions", "OFAC",
        "probability of default", "LGD", "EL", "industry risk", "climate", "Poseidon",
        "internal rating", "PD assessment", "watch list"],
    ...
    5: ["collateral", "mortgage", "refund guarantee", "ACR", "LTV", "LTC",
        "valuation", "vessel value", "Clarkson", "VesselsValue", "distressed",
    ...
    7: ["financial", "revenue", "EBITDA", "net income", "debt", "cash flow", "NTD",
        ...
        "current ratio", "DSCR", "ROA", "ROE", "audit", "IFRS", "depreciation",
        "capex", "free cash flow", "profit", "loss", "equity"],
    8: ["mortgage", "charge", "ACRA", "bank", "lender", "security", "guarantee",
        "legal opinion", "governing law", "jurisdiction", "SIAC", "assignment",
        "negative pledge", "pari passu", "cross default", "conditions precedent"],
    9: ["KYC", "AML", "sanctions", "OFAC", "PEP", "compliance", "FATCA", "CRS",
        "environmental", "EEXI", "CII", "Banking Act", "regulatory", "checklist",
        "World-Check", "Accuity", "due diligence", "beneficial owner"],
